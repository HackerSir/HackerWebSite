                        ...
                        <div class="row">
                            {!! Form::open(['route' => ['course.update', $course->id], 'class' => 'form-horizontal', 'method' => 'PUT']) !!}
                                ...
                                <div class="form-group has-feedback{{ ($errors->has('description'))?' has-error':'' }}">
                                    ...
                                    <div class="col-md-9">
                                        {!! Form::text('description', $course->description, ['id' => 'description', 'placeholder' => '請輸入課程簡介', 'class' => 'form-control']) !!}
                                    ...
                                    <div class="col-md-9">
                                        <select name="tag[]" id="tag" class="form-control" multiple>
                                            @foreach(App\Course::existingTags() as $tag)
                                                <option value="{{ $tag->name }}" @if(in_array($tag->name, $course->tagNames())) selected @endif>{{ $tag->name }}</option>
                                            @endforeach
                                        </select>
